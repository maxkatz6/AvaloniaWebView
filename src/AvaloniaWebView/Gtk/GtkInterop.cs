...
internal static unsafe class GlibInterop
{
    ...
    public static Task RunOnGlibThread(Action action)
    {
        return RunOnGlibThread(() => { action(); return 0; });
    }
}
...
internal static unsafe class GtkInterop
{
    ...
    public static Task<IntPtr> StartGtk()
    {
